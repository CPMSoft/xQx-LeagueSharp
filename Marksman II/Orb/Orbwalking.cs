...
namespace Marksman.Orb
{
    ...
    public static class Orbwalking
    {
        ...
        public static bool CanAttack()
        {
            ...
            {
                var attackDelay = 1.0740296828d * 1000 * Orbwalker.AttackSpeedDelay - 716.2381256175d;
        ...
        public class Orbwalker : IDisposable
        {
            ...
            public Orbwalker(Menu attachToMenu)
            {
                ...
                config.Item("StillCombo").ValueChanged +=
                        ...
                        if (minions.Any())
                        {
                            ...
                            if (turretMinion != null)
                            {
                                ...
                                if (hpLeft == 0 && turretAttackCount != 0 && hpLeftBeforeDie != 0)
                                {
                                    ...
                                    if (hits >= 1
                                        && hits * Orbwalker.AttackSpeedDelay * 1000 + timeUntilAttackReady
                    ...
                    if (!this.ShouldWait())
                    {
                        if (this._prevMinion.IsValidTarget() && this.InAutoAttackRange(this._prevMinion))
                        {
                            var predHealth = HealthPrediction.LaneClearHealthPrediction(
                                this._prevMinion,
                                (int)(Orbwalker.AttackSpeedDelay * 1000 * LaneClearWaitTimeMod),
                                this.FarmDelay);
