    ...
    public static class Orbwalking2
    {
            ...
            bool randomizeMinDistance = true)
        {
            ...
            try
            {
                ...
                {
                    if (Orbwalker.LimitAttackSpeed && (Player.AttackDelay < 1 / Orbwalker.AttackSpeedLimitValue) && _autoattackCounter % 3 != 0
                        && !CanMove(500, true))
                    {
                        return;
                    }
        ...
        public class Orbwalker : IDisposable
        {
            ...
            public static float AttackSpeedLimitValue
            {
                get { return config.Item("AttackSpeedLimiter.MaxAttackSpeed").GetValue<Slider>().Value; }
            }
            ...
            public static bool LimitAttackSpeed
            {
                get
                {
                    return config.Item("AttackSpeedLimiter.Enabled").GetValue<bool>();
                }
            }
